...
<section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4"><span>We Are The Job Hunt Agency</span></h2>
        </div>
        <div>
  				<p>Our agency provides the different variety of jobs in different fields such as Web Development, Graphics Designer, Multomedia,Advertising,PHP-Programming, Software Development,Web Designer etc.</p>
  			</div>
    	</div>
    </section>
